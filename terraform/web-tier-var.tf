...
variable "web_asg_instance_refresh_strategy" {
  type        = string
  default     = "Rolling"
  description = "Strategy to use for instance refresh. The only allowed value is Rolling."
}

variable "web_asg_instref_pref_checkpoint_delay" {
  type        = number
  default     = 600
  description = "Number of seconds to wait after a checkpoint."
}

variable "web_asg_instref_pref_checkpoint_percentages" {
  type        = list(any)
  default     = [35, 70, 100]
...
variable "web_asg_instref_pref_instance_warmup" {
  type        = number
  default     = 300
...
variable "web_asg_instref_pref_min_healthy_percentage" {
  type        = number
  default     = 50
...
variable "web_asg_instref_pref_max_healthy_percentage" {
  type        = number
  default     = 100
...
variable "web_asg_instance_refresh_triggers" {
  type        = list(any)
  default     = ["tag"]
...
variable "web_asg_launch_template_description" {
  type        = string
  default     = "Launch template of the web tier of 3 tier application."
...
variable "web_asg_iam_role_description" {
  type        = string
  default     = "To grant the necessary privileges to the web component in the 3-tier application workload."
  description = "Description of the role."
}

variable "web_asg_iam_role_tages" {
  type = map(any)
  default = {
    CustomIamRole = "Yes"
  }
...
variable "web_asg_iam_role_policies" {
  type = map(any)
  default = {
...
variable "web_asg_blkdevmap_ebs_delete_on_termination" {
  type        = bool
  default     = true
  description = "Whether the volume should be destroyed on instance termination."
}

variable "web_asg_blkdevmap_ebs_encrypted" {
  type        = bool
  default     = true
  description = "Enables EBS encryption on the volume."
}

variable "web_asg_blkdevmap_ebs_volume_size" {
  type        = number
  default     = 20
  description = "The size of the volume in gigabytes."
}

variable "web_asg_blkdevmap_ebs_volume_type" {
  type        = string
  default     = "gp2"
  description = "The volume type. Can be one of standard, gp2, gp3, io1, io2, sc1 or st1."
}

variable "web_asg_tag_specifications" {
  type = list(any)
  default = [
    {
...
variable "web_sg_description" {
  type        = string
  default     = "Security group for web tier with HTTP ports open."
